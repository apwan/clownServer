...
(function() {
    ...
    window.CKEDITOR || (window.CKEDITOR = function() {
        var a = {timestamp: "E4KX",version: "4.4.1",revision: "568b5ed",rnd: Math.floor(900 * Math.random()) + 100,_: {pending: []},status: "unloaded",basePath: function() {
    ...
    (function() {
        ...
        CKEDITOR.tools = {arrayCompare: function(a, d) {
                ...
                if (typeof (f = arguments[d - 1]) == "boolean")
                    d--;
                ...
                for (var a = [].concat(a), d, f = [], b = 0; b < a.length; b++)
                    if (d = a[b])
                        /@import|[{}]/ .
                test(d) ? f.push("<style>" + d + "</style>") : f.push('<link type="text/css" rel=stylesheet href="' + d + '">');
                return f.join("")
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {appendTo: function(a, e) {
            ...
            var b = this.$.cloneNode(a), c = function(d) {
                ...
                if (d.nodeType == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (a)
                        for (var d = d.childNodes, f = 0; f < d.length; f++)
                            c(d[f])
                }
            };
            c(b);
    ...
    (function() {
        ...
        function b(a) {
            for (var f = 0, b = 0, e = c[a].length; b < e; b++)
                f = f + (parseInt(this.getComputedStyle(c[a][b]) || 0, 10) || 0);
            return f
        }
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT,addClass: function(a) {
                ...
                if (f) {
                    a = RegExp("(?:^|\\s+)" + a + "(?=\\s|$)", "i");
                    if (a.test(f))
                        (f = f.replace(a, "").replace(/^\s+/, "")) ? this.setAttribute("class", f) : this.removeAttribute("class")
                }
                return this
            },hasClass: function(a) {
                ...
                try {
                    ...
                    f.$.innerHTML = a;
                    for (f = f.getChildren(); f.count(); )
                        this.append(f.getItem(0));
                    return a
                }
            } : function(a) {
            ...
            function(a) {
                ...
                var f = this.getName();
                if (this.isReadOnly() || this.getComputedStyle("display") == "none" || this.getComputedStyle("visibility") == "hidden" || CKEDITOR.dtd.$nonEditable[f] || CKEDITOR.dtd.$empty[f] || this.is("a") && (this.data("cke-saved-name") || this.hasAttribute("name")) && !this.getChildCount())
                    return false;
                if (a !== false) {
                ...
                if (a && CKEDITOR.env.webkit) {
                    f = this.getWindow();
                    if (!f.equals(CKEDITOR.document.getWindow()) && (b = f.$.frameElement))
            ...
            function() {
                ...
                function a(d, b, c) {
                    if (b && b.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (d.isIdentical(b)) {
                            for (var k = c ? d.getLast() : d.getFirst(); e.length; )
                                e.shift().move(d, !c);
                            b.moveChildren(d, !c);
                            b.remove();
        ...
        function a(a, b) {
            ...
            if (this.current)
                ...
                if (a)
                    ...
                    g = d;
                    if (g.type == CKEDITOR.NODE_ELEMENT && !(g = g.getChild(f)))
                        g = o(d, true) === false ? null : d.getNextSourceNode(true, m, o)
                }
                g && o(g) === false && (g = null)
            }
            for (; g && !this._.end; ) {
    ...
    (function() {
        ...
        var c = function(a) {
            ...
            for (var q = c, k, H, n, C = m; C < e.length; C++) {
                ...
                for (k = k.getNext(); k; ) {
                    if (k.equals(h[C]) || k.equals(f))
                        break;
                    n = k.getNext();
                    if (b == 2)
                        q.append(k.clone(true));
                    else {
                        k.remove();
                        b == 1 && q.append(k)
                    }
            ...
            for (c = m; c < h.length; c++) {
                ...
                if (!e[c] || k.$.parentNode != e[c].$.parentNode)
                    for (k = k.getPrevious(); k; ) {
                        if (k.equals(e[c]) || k.equals(g))
                            break;
                        n = k.getPrevious();
                        if (b == 2)
                            q.$.insertBefore(k.$.cloneNode(true), q.$.firstChild);
                        else {
                            k.remove();
        ...
        {clone: function() {
                ...
                function a(b) {
                    ...
                    if (c.type == CKEDITOR.NODE_TEXT) {
                        g = c;
                        for (f = 0; (g = g.getPrevious()) && g.type == CKEDITOR.NODE_TEXT; )
                            f = f + g.getLength();
                        d = d + f
                    }
                    b.container = c;
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        for (j = c(j); j || m; ) {
                            if (j && !m) {
                                !u && j.equals(f) && (u = true);
                                if (g ? j.isBlockBoundary() : !e.contains(j))
                                    break;
                        ...
                        if (q.type == CKEDITOR.NODE_TEXT)
                            if (CKEDITOR.tools.trim(q.substring(n)).length)
                                h = true;
                            else {
                                h = !q.getLength();
                                if (n == q.getLength()) {
    ...
    (function() {
        ...
        a.prototype = {getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; p; ) {
                    ...
                    if (l)
                        p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (l = 0);
                    else {
                        var m = p.getName();
                ...
                if (!b) {
                    ...
                    z = {div: 1,th: 1,td: 1};
                    b = b.block;
                    if (!b && p && !this.enforceRealBlocks && z[p.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !p.equals(h.root))
                        b = p;
                        ...
                        this._.nextNode = b.equals(g) ? null : e(h.getBoundaryNodes().endNode, 1, g)
                }
                if (r)
                    (r = b.getPrevious()) && r.type == CKEDITOR.NODE_ELEMENT && (r.getName() == "br" ? r.remove() : r.getLast() && r.getLast().$.nodeName.toLowerCase() == "br" && r.getLast().remove());
                if (v)
                    (r = b.getLast()) && r.type == CKEDITOR.NODE_ELEMENT && r.getName() == "br" && (!CKEDITOR.env.needsBrFiller || r.getPrevious(f) || r.getNext(f)) && r.remove();
                if (!this._.nextNode)
                    this._.nextNode = s || b.equals(g) || !g ? null : e(b, 1, g);
                return b
            }};
    ...
    (function() {
        function a(a, b, c, d, g) {
            ...
            for (var b = g.elements, g = g.generic, z, c = 0, d = a.length; c < d; ++c) {
                ...
                for (p in B) {
                    ...
                    u = void 0;
                    for (u in q)
                        u.indexOf("*") > -1 ? w.push(RegExp("^" + u.replace(/\*/g, ".*") + "$")) : w.push(u);
                    q = w;
                    if (q.length) {
                        j[l] = q;
                        m = false
        ...
        function n(a, b) {
            ...
            if (g = a.requiredClasses) {
                ...
                for (c = 0; c < g.length; ++c) {
                    d = g[c];
                    if (typeof d == "string") {
                        if (CKEDITOR.tools.indexOf(f, d) == -1)
                            return false
        ...
        function v(a, b, d, g) {
            ...
            if (g.doFilter) {
                ...
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (y in k)
                        a.allStyles || i[y] ? N.push(y + ":" + k[y]) : w = true;
                    if (N.length)
                        l.style = N.sort().join("; ")
                } else if (B)
                    l.style = B;
        ...
        CKEDITOR.filter.prototype = {allow: function(b, c, d) {
                ...
                this.editor.enterMode : CKEDITOR.ENTER_P)]; c = f.pop(); )
                    c.type == CKEDITOR.NODE_ELEMENT ? m(c, d, a) : c.remove();
                for (; q = a.pop(); ) {
                    c = q.el;
                    if (c.parent)
                        switch (q.check) {
            ...
            var f = {}, h = function(b) {
                a.call(this, b, function(a) {
                    ...
                    for (n in a) {
                        ...
                        if (!e[n]) {
                            if (s.icons)
                                for (var v = s.icons.split(","), g = v.length; g--; )
                                    CKEDITOR.skin.addIcon(v[g], s.path + "icons/" + (CKEDITOR.env.hidpi && s.hidpi ? "hidpi/" : "") + v[g] + ".png");
                            e[n] = 1
                        }
                        if (r) {
                            r.split && (r = r.split(","));
    ...
    (function() {
        ...
        function o(a) {
            ...
            if (f)
                var m = RegExp("(?:^|,)(?:" + f.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), c = c.replace(m, "");
            CKEDITOR.env.air && 
            (c = c + ",adobeair");
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var j in c) {
                    ...
                    if (h && !a.lang[j]) {
                        ...
                        if (!l.langEntries || !l.langEntries[i])
                            e.push(CKEDITOR.getUrl(l.path + "lang/" + i + ".js"));
                        else {
                ...
                CKEDITOR.scriptLoader.load(e, function() {
                    ...
                    for (j = 0; j < a.config.blockedKeystrokes.length; j++)
                        a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[j]] = 1;
                    a.status = "loaded";
                    a.fireOnce("loaded");
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.prototype = {onTagOpen: function() {
                ...
                if (b.length > 
                f)
                    this.onText(b.substring(f, b.length))
            }}
    })();
                        ...
                        for (; ; ) {
                            ...
                            if (!f.isUnknown && !l.isUnknown && !p[d])
                                if (l.isOptionalClose)
                                    ...
                                    l = h
                                } else if (d in CKEDITOR.dtd.$listItem && !v(d, h))
    ...
    (function() {
        ...
        a.prototype = {add: function(a, c, d) {
            ...
            c, d) {
                for (var f = [this.findIndex(c), 0], e = 0, n = a.length; e < n; e++)
                    f.push({value: a[e],priority: c,options: d});
                ...
                for (s = 0; s < n; s++) {
                    ...
                    a.nestedEditable && o.options.excludeNestedEditable)) {
                        ...
                        if (o === false || d && o && (o.name != k || o.type != i))
                            return o;
                        o != void 0 && (f[0] = c = o)
                    }
                }
    ...
    (function() {
        function a(a, e) {
                    ...
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (j = typeof d == "function" ? d(e) !== false : d)
                            ...
                            e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
                                j = false;
                            else if (!p && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem))
                                j = false;
                            else {
                                j = b(e);
            ...
            function t(a, b) {
                if ((!p || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && a.name == "br" && !a.attributes["data-cke-eol"])
                    return true;
                var c;
                if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(z))) {
                    ...
                    if (!CKEDITOR.env.needsBrFiller && p && (!b || a.parent.name in i))
                        return true;
                    if (!p)
            ...
            for (u in i)
                "#" in l[u] || delete i[u];
            for (u in i)
                q.elements[u] = j(p, a.config.fillEmptyBlocks !== false);
            q.root = j(p);
        ...
        var z = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", l = CKEDITOR.dtd, j = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], m = CKEDITOR.tools.extend({}, l.$blockLimit, l.$block), u = {elements: {input: n,textarea: n}}, P = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, q = {elements: {embed: function(a) {
                    var b = a.parent;
                    if (b && b.name == "object") {
                    ...
                    if (!a.children.length && !a.attributes.name && !a.attributes["data-cke-saved-name"])
                        return false
                }}}, L = {elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]],attributeNames: [[/^data-cke-(saved|pa)-/, ""], [/^data-cke-.*/, ""], ["hidefocus", ""]],elements: {$: function(a) {
                    var b = a.attributes;
                    if (b) {
                        if (b["data-cke-temp"])
                            return false;
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {type: CKEDITOR.NODE_ELEMENT,add: b.add,clone: function() {
                ...
                for (var b = this.children.splice(a, this.children.length - a), f = this.clone(), e = 0; e < b.length; ++e)
                    b[e].parent = f;
                f.children = b;
                if (b[0])
                    b[0].previous = null;
                ...
                if (b.length)
                    for (var a = CKEDITOR.tools.copy(a), f = 0; f < b.length; f = f + 2)
                        a[b[f]] = b[f + 1];
                return a
            }}, true)
    })();
        ...
        function(a, b) {
            ...
            if (!(a == c.mode || !e || !e[a])) {
                ...
                if (c.mode) {
                    ...
                    c._.previousModeData = c.getData(1);
    ...
    (function() {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({base: CKEDITOR.dom.element,$: function(a, b) {
                ...
                changeAttr: function(a, b) {
                    ...
                    if (!b) {
                        var e = /\n{2}/g;
                        if (e.test(a))
                            var f = "<" + c + ">", m = "</" + c + ">", a = f + a.replace(e, function() {
                                return m + f
                            }) + m
                    }
                    a = a.replace(/\n/g, "<br>");
                ...
                b) {
                    ...
                    var m, h;
                    if (f)
                        for (; (m = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[m.getName()]) && (!h || !h[e]); )
                            if (m.getName() in CKEDITOR.dtd.span)
                                b.splitElement(m);
                            ...
                            if (c in l) {
                                ...
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (e = b.getSelectedElement()) || (e = f(b))) {
                                    ...
                                    p.is("table") && q[c ? "checkStartOfBlock" : "checkEndOfBlock"]()) {
                                        ...
                                        a.fire("saveSnapshot");
                                        d = 1
                                    } else if ((k = h.contains(["td", "th", "caption"])) && q.checkBoundaryOfElement(k, c ? CKEDITOR.START : CKEDITOR.END))
                                        d = 1
                            }
                            return !d
                        });
                            ...
                            if (b in l) {
                                ...
                                f && d[b ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(f, !b) && d.collapsed) {
                                    ...
                                    if ((d = d.startPath().block) && (!d || !d.contains(f))) {
                                        a.fire("saveSnapshot");
                                        for (var i = f.getCommonAncestor(d), k = b ? f : d, h = k; (k = k.getParent()) && !i.equals(k) && k.getChildCount() == 1; )
                                            h = k;
                                        var p;
        ...
        var r = function() {
            ...
            function b(c, d) {
                ...
                if (u > -1)
                    t[u].firstNotAllowed = 1;
                if (o > -1)
                    t[o].lastNotAllowed = 1;
                return t
            }
            function d(b, c) {
            ...
            i, u) {
                ...
                if (!s.checkReadOnly()) {
                    ...
                    for (; (w = a(o.startContainer) && o.startContainer.getChild(o.startOffset - 1)) && a(w) && w.isBlockBoundary() && y.contains(w); )
                        o.moveToPosition(w, CKEDITOR.POSITION_BEFORE_END);
                    ...
                    for (t = x.startNode; (t = t.getParent()) && e(t); )
                        r.push(t);
                    o.moveToBookmark(x);
                    if (x = u) {
                        x = i.range;
                        ...
                        if (/^\s+|\s+$/.test(u) && "span" in CKEDITOR.dtd[w])
                            var M = '<span data-cke-marker="1">&nbsp;</span>', u = M + u + M;
                        ...
                        if ((M = x.startPath().block) && !(M.getChildCount() == 1 && M.getBogus()))
                            a: {
                                var D;
                    ...
                    if (S)
                        for (; E = S.pop(); )
                            CKEDITOR.env.needsBrFiller ? E.appendBogus() : E.append(I.document.createText(" "));
                    for (; E = i.mergeCandidates.pop(); )
                        E.mergeSiblings();
                    I.moveToBookmark(T);
                    if (!i.dontMoveCaret) {
    ...
    (function() {
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            d.on("contentDom", function() {
                ...
                if (h && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    ...
                    g.attachListener(CKEDITOR.env.ie ? g : b.getDocumentElement(), "mouseup", e, d);
        ...
        CKEDITOR.dom.selection = function(a) {
            ...
            if (d)
                if (d.getRangeAt)
                    f = (g = d.rangeCount && d.getRangeAt(0)) && new CKEDITOR.dom.node(g.commonAncestorContainer);
                else {
                    try {
                        g = d.createRange()
                    } catch (h) {
        ...
        CKEDITOR.dom.selection.prototype = {getNative: function() {
                ...
                if (!c || !c.rangeCount)
                    ...
                    if (d == c.endContainer && 
                    d.nodeType == 1 && c.endOffset - c.startOffset == 1 && A[d.childNodes[c.startOffset].nodeName.toLowerCase()])
                        b = CKEDITOR.SELECTION_ELEMENT
                }
                return a.type = b
            },getRanges: function() {
                ...
                var b = this, c = CKEDITOR.tools.tryThese(function() {
                    ...
                    !(c.type == CKEDITOR.NODE_ELEMENT && A[c.getName()] && (d = c))); e--)
                    ...
                    if (this.isLocked) {
                        ...
                        if (h)
                            ...
                            if (p) {
                                ...
                                if ((d = h.getEnclosedNode()) && d.type == CKEDITOR.NODE_ELEMENT && d.getName() in A && (!d.is("a") || !d.getText()))
                                    try {
    ...
    (function() {
                        ...
                        if (A)
                            if ((A = n.getParent()) && ((A.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(A))) {
                                ...
                                if (q == CKEDITOR.NODE_TEXT || r || q == CKEDITOR.NODE_ELEMENT && !n.getChildCount()) {
                                    for (var q = n, L; (i = !q.getNext(G)) && (L = q.getParent(), j[L.getName()]) && (L.getPosition(m) | F) == F && (!g.childRule || g.childRule(L)); )
                                        q = L;
                                    p.setEndAfter(q)
                                }
                            } else
                        ...
                        for (var i = z(this, d), r = i.hasAttributes(), s = p.getCommonAncestor(), q = {}, A = {}, C = {}, H = {}, V, R, Y; i && s; ) {
                            if (s.getName() == f) {
                                for (V in g.attributes)
                                    if (!H[V] && 
                                    (Y = s.getAttribute(R)))
                                        i.getAttribute(V) == Y ? A[V] = 1 : H[V] = 1;
                                for (R in g.styles)
                                    if (!C[R] && (Y = s.getStyle(R)))
                                        i.getStyle(R) == Y ? q[R] = 1 : C[R] = 1
                            }
                            s = s.getParent()
                        }
                        for (V in A)
        ...
        CKEDITOR.style.prototype = {apply: function(a) {
                if (a instanceof CKEDITOR.dom.document)
                    return u.call(this, a.getSelection());
                ...
                if (a instanceof CKEDITOR.dom.document)
                    return u.call(this, a.getSelection(), 1);
                if (this.checkApplicable(a.elementPath(), a)) {
                    var b = this._.enterMode;
                    if (!b)
                        this._.enterMode = a.activeEnterMode;
        ...
        CKEDITOR.dialog.prototype = {destroy: function() {
                ...
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    for (var b = [], c = a.label ? ' title="' + CKEDITOR.tools.htmlEncode(a.label) + '"' : "", e = CKEDITOR.dialog._.uiElementBuilders.vbox.build(this, {type: "vbox",
                        className: "cke_dialog_page_contents",children: a.elements,expand: !!a.expand,padding: a.padding,style: a.style || "width: 100%;"}, b), d = this._.contents[a.id] = {}, g = e.getChild(), f = 0; e = g.shift(); )
    ...
    (function() {
        ...
        CKEDITOR.plugins.link = {getSelectedLink: function(c) {
                ...
                for (var b = c.editable(), a = b.isInline() && !c.plugins.divarea ? c.document : b, b = a.getElementsByTag("a"), a = a.getElementsByTag("img"), f = [], e = 0, d; d = b.getItem(e++); )
                    if (d.data("cke-saved-name") || d.hasAttribute("name"))
                        f.push({name: d.data("cke-saved-name") || 
        ...
        CKEDITOR.removeAnchorCommand.prototype = {exec: function(c) {
                ...
                if (b && (f = b.getSelectedElement()) && (!f.getChildCount() ? CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, f) : f.is("a")))
                    ...
                    f.hasAttribute("href") ? (f.removeAttributes({name: 1,"data-cke-saved-name": 1}), f.removeClass("cke_anchor")) : f.remove(1);
                b.selectBookmarks(a)
    ...
    (function() {
        function f(a, b, c) {
            ...
            if (e && (c = a.fire("uiSpace", {space: b,html: ""}).html))
                a.on("uiSpace", function(a) {
                    a.data.space == b && a.cancel()
                }, null, null, 1), d = e.append(CKEDITOR.dom.element.createFromHtml(g.output({id: a.id,name: a.name,langDir: a.lang.dir,langCode: a.langCode,space: b,spaceId: a.ui.spaceId(b),content: c}))), e.getCustomData("cke_hasshared") ? d.hide() : e.setCustomData("cke_hasshared", 1), d.unselectable(), d.on("mousedown", function(a) {
                    a = a.data;
                    a.getTarget().hasAscendant("a", 
                    1) || a.preventDefault()
                }), a.focusManager.add(d, 1), a.on("focus", function() {
                    for (var a = 0, b, c = e.getChildren(); b = c.getItem(a); a++)
        ...
        CKEDITOR.plugins.add("sharedspace", {init: function(a) {
                a.on("loaded", function() {
    ...
    (function() {
        ...
        f.prototype = {equalsContent: function(a) {
                ...
                if (c || a) {
                    ...
                    for (var d = 0; d < c.length; d++) {
                        ...
                        e.endOffset || !CKEDITOR.tools.arrayCompare(b.start, e.start) || !CKEDITOR.tools.arrayCompare(b.end, e.end))
                            return !1
                    }
                }
                return !0
        ...
        g.prototype = {type: function(a, c) {
                ...
                var b = this.editor;
                if (this.locked || "ready" != b.status || "wysiwyg" != b.mode)
                    return !1;
                var e = b.editable();
                if (!e || "ready" != e.status)
                    return !1;
                ...
                if (!this.locked) {
                    ...
                    for (var c = 
                    this.index, d = this.snapshots; 0 < c && this.currentImage.equalsContent(d[c - 1]); )
                        c -= 1;
    ...
    CKEDITOR.config.plugins = 'basicstyles,blockquote,dialogui,dialog,clipboard,panel,floatpanel,menu,contextmenu,elementspath,enterkey,entities,popup,filebrowser,floatingspace,listblock,button,richcombo,format,horizontalrule,htmlwriter,indent,indentlist,justify,fakeobjects,link,list,maximize,pastefromword,pastetext,removeformat,sharedspace,sourcearea,stylescombo,tab,toolbar,undo,wysiwygarea';
    ...
    (function() {
        ...
        if (CKEDITOR.env.hidpi)
            setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,blockquote,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,horizontalrule,312,,indent-rtl,336,,indent,360,,outdent-rtl,384,,outdent,408,,justifyblock,432,,justifycenter,456,,justifyleft,480,,justifyright,504,,anchor-rtl,528,,anchor,552,,link,576,,unlink,600,,bulletedlist-rtl,624,,bulletedlist,648,,numberedlist-rtl,672,,numberedlist,696,,maximize,720,,pastefromword-rtl,744,,pastefromword,768,,pastetext-rtl,792,,pastetext,816,,removeformat,840,,source-rtl,864,,source,888,,redo-rtl,912,,redo,936,,undo-rtl,960,,undo,984,', 'icons_hidpi.png');
        else
            setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,blockquote,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,horizontalrule,312,auto,indent-rtl,336,auto,indent,360,auto,outdent-rtl,384,auto,outdent,408,auto,justifyblock,432,auto,justifycenter,456,auto,justifyleft,480,auto,justifyright,504,auto,anchor-rtl,528,auto,anchor,552,auto,link,576,auto,unlink,600,auto,bulletedlist-rtl,624,auto,bulletedlist,648,auto,numberedlist-rtl,672,auto,numberedlist,696,auto,maximize,720,auto,pastefromword-rtl,744,auto,pastefromword,768,auto,pastetext-rtl,792,auto,pastetext,816,auto,removeformat,840,auto,source-rtl,864,auto,source,888,auto,redo-rtl,912,auto,redo,936,auto,undo-rtl,960,auto,undo,984,auto', 'icons.png');
    })();
