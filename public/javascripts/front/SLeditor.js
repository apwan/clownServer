...
SL("editor.blocks").Base = Class.extend({
    init: function(e, t) {
        ...
        if (this.domElement.css({width: this.options.horizontalResizing ? i : "auto",height: this.options.verticalResizing ? n : "auto"}), this.transform.isResizingCentered() || e.center) {
            var s = this.measure();
        ...
        var e = this.domElement.get(0), t = {x: e.offsetLeft,y: e.offsetTop,width: this.domElement.outerWidth(),height: this.domElement.outerHeight()};
    ...
    }}), SL("editor.blocks.behavior").Transform = Class.extend({ANCHOR_SIZE: 16,init: function(e) {
        this.block = e, this.state = {direction: null,centered: !1,proportional: !1,originalMeasurements: null,originalCursorPosition: {x: 0,y: 0}}, this.render(), this.bind()
    },render: function() {
        this.domElement = $('<div class="sl-block-transform editing-ui">'), this.domElement.attr({"data-horizontal": this.block.options.horizontalResizing,"data-vertical": this.block.options.verticalResizing}), this.anchors = {}, this.anchors.n = $('<div class="anchor" data-direction="n">').appendTo(this.domElement), this.anchors.e = $('<div class="anchor" data-direction="e">').appendTo(this.domElement), this.anchors.s = $('<div class="anchor" data-direction="s">').appendTo(this.domElement), this.anchors.w = $('<div class="anchor" data-direction="w">').appendTo(this.domElement), this.anchors.nw = $('<div class="anchor" data-direction="nw">').appendTo(this.domElement), this.anchors.ne = $('<div class="anchor" data-direction="ne">').appendTo(this.domElement), this.anchors.se = $('<div class="anchor" data-direction="se">').appendTo(this.domElement), this.anchors.sw = $('<div class="anchor" data-direction="sw">').appendTo(this.domElement)
    },bind: function() {
        ...
        e.preventDefault(), this.moved || (this.resizeStarted.dispatch(this), SL.editor.controllers.Guides.start([this.block], {action: "resize",direction: this.state.direction})), this.moved = !0;
        ...
        this.block.hasAspectRatio() ? ("" === n && (n = this.state.originalMeasurements.width * (o / this.state.originalMeasurements.height)), "" === o && (o = this.state.originalMeasurements.height * (n / this.state.originalMeasurements.width))) : ("" === n && (n = this.state.originalMeasurements.width), "" === o && (o = this.state.originalMeasurements.height)), this.state.centered = e.altKey, this.state.proportional = e.shiftKey, this.block.resize({width: n,height: o,direction: this.state.direction}), SL.editor.controllers.Guides.sync()
    },onMouseUp: function(e) {
    ...
    }}), SL("editor.blocks").Code = SL.editor.blocks.Base.extend({init: function(e) {
        this._super("code", e), this.editingRequested = new signals.Signal
    },setup: function() {
        this._super(), this.properties.code = {value: {setter: this.setCode.bind(this),getter: this.getCode.bind(this)},language: {defaultValue: "none",setter: this.setCodeLanguage.bind(this),getter: this.getCodeLanguage.bind(this),options: [{value: "none",title: "Automatic"}, {value: "actionscript",title: "ActionScript"}, {value: "apache",title: "Apache"}, {value: "applescript",title: "AppleScript"}, {value: "bash",title: "Bash"}, {value: "clojure",title: "Clojure"}, {value: "coffeescript",title: "CoffeeScript"}, {value: "cpp",title: "C++"}, {value: "cs",title: "C#"}, {value: "css",title: "CSS"}, {value: "diff",title: "Diff"}, {value: "django",title: "Django "}, {value: "dos",title: "DOS"}, {value: "erlang",title: "Erlang"}, {value: "fsharp",title: "F#"}, {value: "glsl",title: "GLSL"}, {value: "go",title: "Go"}, {value: "haml",title: "Haml"}, {value: "handlebars",title: "Handlebars"}, {value: "haskell",title: "Haskell"}, {value: "xml",title: "HTML"}, {value: "http",title: "HTTP"}, {value: "ini",title: "Ini file"}, {value: "java",title: "Java"}, {value: "javascript",title: "JavaScript"}, {value: "json",title: "JSON"}, {value: "lisp",title: "Lisp"}, {value: "livecodeserver",title: "LiveCode Server"}, {value: "lua",title: "Lua"}, {value: "makefile",title: "Makefile"}, {value: "markdown",title: "Markdown"}, {value: "mathematica",title: "Mathematica"}, {value: "matlab",title: "Matlab"}, {value: "nginx",title: "nginx"}, {value: "objectivec",title: "Objective C"}, {value: "perl",title: "Perl"}, {value: "php",title: "PHP"}, {value: "python",title: "Python"}, {value: "ruby",title: "Ruby"}, {value: "scala",title: "Scala"}, {value: "scss",title: "SCSS"}, {value: "smalltalk",title: "SmallTalk"}, {value: "sql",title: "SQL"}, {value: "tex",title: "TeX"}, {value: "vbnet",title: "VB.NET"}, {value: "vbscript",title: "VBScript"}, {value: "vim",title: "vim"}, {value: "xml",title: "XML"}]}}
    },paint: function() {
    ...
    }}), SL("editor.blocks").Iframe = SL.editor.blocks.Base.extend({init: function(e) {
        this._super("iframe", e), this.editingRequested = new signals.Signal, this.paint()
    },setup: function() {
        this._super(), this.setIframeURL = this.setIframeURL.bind(this), this.getIframeURL = this.getIframeURL.bind(this), this.setIframeURL = $.debounce(this.setIframeURL, 400), this.properties.iframe = {src: {setter: this.setIframeURL,getter: this.getIframeURL}}
    },paint: function() {
        ...
        return 0 === e.length && (e = $("<iframe>").appendTo(this.contentElement)), e.attr({webkitallowfullscreen: "",mozallowfullscreen: "",allowfullscreen: "",sandbox: "allow-forms allow-scripts allow-popups allow-same-origin allow-pointer-lock"}), e
    },isEmpty: function() {
        ...
        this._super(e), 13 !== e.keyCode || SL.util.isTypingEvent(e) || (this.editingRequested.dispatch(), e.preventDefault())
    }}), SL("editor.blocks").Image = SL.editor.blocks.Base.extend({init: function(e) {
        ...
        this._super(), this.properties.image = {src: {setter: this.setImageURL.bind(this),getter: this.getImageURL.bind(this)}}
    },bind: function() {
    ...
    }}), SL("editor.blocks").Math = SL.editor.blocks.Base.extend({init: function(e) {
        this._super("math", $.extend(e, {horizontalResizing: !1,verticalResizing: !1})), this.editingRequested = new signals.Signal
    },setup: function() {
        this._super(), this.properties.math = {value: {setter: this.setValue.bind(this),getter: this.getValue.bind(this)}}
    },paint: function() {
        ...
        this._super(e), 13 !== e.keyCode || SL.util.isTypingEvent(e) || (this.editingRequested.dispatch(), e.preventDefault())
    }}), SL("editor.blocks.plugin").HTML = Class.extend({init: function(e) {
    ...
    }}), SL("editor.blocks.plugin").Link = Class.extend({init: function(e) {
        ...
        }.bind(e), this.block.properties.link = {href: {setter: this.block.setLinkURL,getter: this.block.getLinkURL,checker: this.block.isLinked}}
    },destroy: function() {
        delete this.block.properties.link, delete this.block.setLinkURL, delete this.block.getLinkURL, delete this.block.isLinked
    }}), SL("editor.blocks").Shape = SL.editor.blocks.Base.extend({init: function(e) {
        this._super("shape", $.extend({minWidth: 4,minHeight: 4}, e)), this.plug(SL.editor.blocks.plugin.Link)
    },setup: function() {
        this._super(), this.properties.attribute["data-shape-type"] = {defaultValue: "rect",options: [{value: "rect"}, {value: "circle"}, {value: "diamond"}, {value: "octagon"}, {value: "triangle-up"}, {value: "triangle-down"}, {value: "triangle-left"}, {value: "triangle-right"}, {value: "arrow-up"}, {value: "arrow-down"}, {value: "arrow-left"}, {value: "arrow-right"}]};
        for (var e in SL.util.svg.SYMBOLS)
            this.properties.attribute["data-shape-type"].options.push({value: "symbol-" + e});
        this.properties.attribute["data-shape-stretch"] = {defaultValue: !1}, this.properties.attribute["data-shape-fill-color"] = {defaultValue: "#000000"}, this.properties.attribute["data-shape-stroke-color"] = {}, this.properties.attribute["data-shape-stroke-width"] = {type: "number",decimals: 0,minValue: 1,maxValue: 50,defaultValue: 0}
    },bind: function() {
        this._super(), this.propertyChanged.add(this.onPropertyChanged.bind(this))
    },setDefaults: function() {
        this._super(), this.resize({width: 300,height: 300}), this.set("attribute.data-shape-type", this.getPropertyDefault("attribute.data-shape-type")), this.set("attribute.data-shape-fill-color", this.getPropertyDefault("attribute.data-shape-fill-color")), this.set("attribute.data-shape-stretch", this.getPropertyDefault("attribute.data-shape-stretch"))
    },paint: function() {
        ...
        this.hasStroke() ? this.unset(["attribute.data-shape-stroke-color", "attribute.data-shape-stroke-width"]) : this.set({"attribute.data-shape-stroke-color": "#000000","attribute.data-shape-stroke-width": 1}), this.paint()
    },hasStroke: function() {
...
SL("editor.blocks").Snippet = SL.editor.blocks.Base.extend({
    init: function(e) {
        ...
        this._super(), this.resize({width: SL.editor.blocks.Snippet.DEFAULT_WIDTH,height: SL.editor.blocks.Snippet.DEFAULT_HEIGHT})
...
SL("editor.blocks").Text = SL.editor.blocks.Base.extend({
    init: function(e) {
    ...
    }}), SL.editor.blocks.Text.DEFAULT_WIDTH = 600, SL("editor.components").Colorpicker = Class.extend({init: function(e) {
        ...
        this.hasRenderedColorPicker || (this.hasRenderedColorPicker = !0, this.apiElement.spectrum({flat: !0,showInput: !0,showButtons: !1,showInitial: !0,showPalette: !0,showPaletteOnly: !0,togglePaletteOnly: !0,showSelectionPalette: !0,hideAfterPaletteSelect: !0,maxSelectionSize: 10,togglePaletteMoreText: "More options",togglePaletteLessText: "Less options",preferredFormat: "hex",localStorageKey: "sl-colors",className: "sl-colorpicker-spectrum",move: function(e) {
        ...
        this.domElement.css({left: a,top: l}), this.arrowElement.css({left: arrowX,top: arrowY}), this.domElement.attr("data-alignment", this.config.alignment)
    },show: function(e) {
        if (!e.anchor)
            throw "Can not show color picker without anchor.";
        this.domElement.appendTo(document.body), this.config = $.extend({alignment: "l",offsetX: 0,offsetY: 0,alpha: !1,resetText: "Use default",chooseText: "Done",resetCallback: function() {
        ...
        this.layout()
    }}), SL("editor.components").Sidebar = Class.extend({init: function(e) {
        ...
        this.moreOptionsElement = this.sidebarElement.find(".more-options"), this.moreOptions = new SL.components.Menu({anchor: this.moreOptionsElement,anchorSpacing: 10,alignment: "r",showOnHover: !0,options: [{label: "Present",icon: "play",callback: function() {
                        SL.analytics.trackEditor("Sidebar: Present"), window.open(SL.routes.DECK_LIVE(SLConfig.deck.user.username, SLConfig.deck.slug))
                    }.bind(this)}, {label: "Duplicate",icon: "fork",callback: function() {
                        SL.analytics.trackEditor("Sidebar: Duplicate deck"), SL.editor.controllers.API.forkDeck()
                    }.bind(this)}, {label: "Delete",icon: "trash-fill",callback: function() {
        ...
        this.sidebarScrollShadowBottom.css({opacity: o ? 1 - r : 0,bottom: this.sidebarHeader.outerHeight()}), this.sidebarScrollShadowTop.css({opacity: o ? r : 0,top: this.sidebarSecondary.offset().top})
    },open: function(e) {
        ...
        if (e.preventDefault(), SL.util.user.isPro() || SLConfig.deck.visibility === SL.models.Deck.VISIBILITY_SELF) {
            var t = [];
            t.push({html: SL.locale.get("DECK_VISIBILITY_CHANGE_SELF"),selected: SLConfig.deck.visibility === SL.models.Deck.VISIBILITY_SELF,callback: function() {
                ...
                }.bind(this)}), SL.current_user.isEnterprise() && t.push({html: SL.locale.get("DECK_VISIBILITY_CHANGE_TEAM"),selected: SLConfig.deck.visibility === SL.models.Deck.VISIBILITY_TEAM,className: "divider",callback: function() {
                ...
                }.bind(this)}), t.push({html: SL.locale.get("DECK_VISIBILITY_CHANGE_ALL"),selected: SLConfig.deck.visibility === SL.models.Deck.VISIBILITY_ALL,callback: function() {
                ...
                }.bind(this)}), SL.prompt({anchor: this.publishButton,alignment: "r",type: "select",data: t}), SL.analytics.trackEditor("Visibility menu opened", SLConfig.deck.visibility)
        } else
    ...
    }}), SL("editor.components.sidebar").Base = Class.extend({init: function() {
        ...
        this.layout()
    }}), SL("editor.components.sidebar").Export = SL.editor.components.sidebar.Base.extend({init: function() {
        this.domElement = $(".sidebar-panel .export"), this.htmlOutputElement = this.domElement.find(".deck-html-contents"), this.cssOutputElement = this.domElement.find(".deck-css-contents"), this.downloadRevealElement = this.domElement.find(".section.download-reveal"), this.downloadPDFElement = this.domElement.find(".section.download-pdf"), this.downloadPDFButton = this.domElement.find(".download-pdf-button"), this.downloadPDFButtonLabel = this.domElement.find(".download-pdf-button .label"), this.downloadPDFButtonLabel.length && (this.downloadPDFButtonLoader = Ladda.create(this.downloadPDFButton.get(0))), this.downloadHTMLButton = this.domElement.find(".download-html-button"), this.dropboxElement = this.domElement.find(".section.dropbox"), this.dropboxContents = this.dropboxElement.find(".contents"), this.dropboxPollGoal = null, this.pdfExportId = null, this.onDropboxPoll = this.onDropboxPoll.bind(this), this.onDropboxPollTimeout = this.onDropboxPollTimeout.bind(this), this.dropboxPollJob = new SL.helpers.PollJob({interval: 2e3,timeout: 3e5}), this.dropboxPollJob.polled.add(this.onDropboxPoll), this.dropboxPollJob.ended.add(this.onDropboxPollTimeout), this.onPDFExportPoll = this.onPDFExportPoll.bind(this), this.onPDFExportPollTimeout = this.onPDFExportPollTimeout.bind(this), this.pdfPollJob = new SL.helpers.PollJob({interval: 1e3,timeout: 18e4}), this.pdfPollJob.polled.add(this.onPDFExportPoll), this.pdfPollJob.ended.add(this.onPDFExportPollTimeout), this._super(), this.updatePDFExportButton()
    },bind: function() {
        ...
        if (SL.view.isDeveloperMode()) {
            if (this.downloadRevealElement.show(), this.htmlOutputElement.length) {
                var e = SL.view.getCurrentTheme(), t = "theme-font-" + e.get("font"), i = "theme-color-" + e.get("color"), n = ['<div class="' + t + " " + i + '" style="width: 100%; height: 100%;">', '<div class="reveal">', '<div class="slides">', SL.editor.controllers.Serialize.getDeckAsString({removeSlideIds: !0,removeBlockIds: !0,removeTextPlaceholders: !0}), "</div>", "</div>", "</div>"].join("");
                this.htmlOutputElement.val(SL.util.html.indent(n))
            }
            this.cssOutputElement.length && (this.cssOutputElement.val("Loading..."), $.ajax({url: SL.config.ASSET_URLS["offline-v2.css"],context: this}).fail(function() {
    ...
    }}), SL("editor.components.sidebar").ImportFile = Class.extend({init: function(e) {
        ...
        if (t) {
            ...
            i = i.trim(), i = i.replace(/\s/g, "-").replace(/[^a-zA-Z0-9-_\.]*/g, ""), $.ajax({type: "POST",url: SL.config.AJAX_PDF_IMPORT_NEW,data: {deck_id: SLConfig.deck.id,filename: i},context: this}).fail(function() {
        ...
        n.succeeded.add(function() {
            n.destroy(), this.createFileInput(), this.startTimeout(), SL.analytics.trackEditor("Import PDF/PPT", "upload complete"), $.ajax({type: "PUT",url: SL.config.AJAX_PDF_IMPORT_UPLOADED(e),data: {"import": {upload_complete: !0}},context: this}).fail(function() {
        ...
        if (SL.analytics.trackEditor("Import PDF/PPT", "import complete"), this.stopTimeout(), e.output && e.output.length > 0) {
            ...
            e.output.forEach(function(e) {
                ...
                n.attr({"data-background-image": e,"data-background-image-original": e}), n.appendTo(t), n.on("click", function() {
    ...
    }}), SL("editor.components.sidebar").ImportReveal = Class.extend({init: function(e) {
        ...
        var t = this.validate();
        t && t.length && SL.prompt({anchor: $(e.currentTarget),title: SL.locale.get("DECK_IMPORT_HTML_CONFIRM"),type: "select",data: [{html: "<h3>Cancel</h3>"}, {html: "<h3>Import</h3>",selected: !0,className: "positive",callback: function() {
                        SL.editor.controllers.Markup.importSlides(t, !0), this.reset(), this.importCompleted.dispatch()
                    }.bind(this)}]})
    }}), SL("editor.components.sidebar").Import = SL.editor.components.sidebar.Base.extend({init: function() {
    ...
    }}), SL("editor.components.sidebar").Revisions = SL.editor.components.sidebar.Base.extend({init: function() {
        ...
        this.loading || this.loadedAllPages || (this.loading = !0, $.ajax({url: SL.config.AJAX_GET_DECK_VERSIONS(SLConfig.deck.id, this.page),data: {page: this.page},context: this}).done(function(e) {
        ...
        r.attr({href: SL.config.AJAX_PREVIEW_DECK_VERSION(SLConfig.deck.user.username, SLConfig.deck.slug || SLConfig.deck.id, e.content_uuid),target: "_blank"}), r.on("click", this.onPreviewClicked.bind(this, e, r))
        ...
        r.on("click", this.onRestoreClicked.bind(this, e, r)), SL.modal.open("preview-deck", {src: n,footer: o}), SL.analytics.trackEditor("Revision preview"), i.preventDefault()
    },onRestoreClicked: function(e, t, i) {
        SL.prompt({anchor: $(i.currentTarget),title: SL.locale.get("DECK_RESTORE_CONFIRM", {time: moment(e.created_at).fromNow()}),type: "select",data: [{html: "<h3>Cancel</h3>"}, {html: "<h3>Restore</h3>",selected: !0,className: "negative",callback: this.onRestoreConfirmed.bind(this, e, t)}]}), i.preventDefault()
    },onRestoreConfirmed: function(e) {
        SL.analytics.trackEditor("Revision restore"), SL.helpers.PageLoader.show("Restoring..."), $.ajax({type: "post",url: SL.config.AJAX_RESTORE_DECK_VERSION(SLConfig.deck.id, e.id),data: e,context: this}).done(function(e) {
...
SL("editor.components.sidebar").Style = SL.editor.components.sidebar.Base.extend({
    init: function() {
        ...
        this._super(), this.themeoptions ? this.themeoptions.populate(SL.models.Theme.fromDeck(SLConfig.deck)) : (this.themeoptions = new SL.components.ThemeOptions({center: !1,rollingLinks: !1,fonts: SL.config.THEME_FONTS,colors: SL.config.THEME_COLORS,themes: SL.current_user.getThemes(),model: SL.models.Theme.fromDeck(SLConfig.deck),container: this.domElement.find(".panel-body")}), this.themeoptions.changed.add(this.onThemeOptionsChanged.bind(this))), this.scroll(), this.layout()
    },close: function() {
        this._super()
    },revert: function() {
        ...
        SLConfig.deck.dirty = !0, SLConfig.deck.theme_id = e.get("id"), SLConfig.deck.theme_font = e.get("font"), SLConfig.deck.theme_color = e.get("color"), SLConfig.deck.center = e.get("center"), SLConfig.deck.rolling_links = e.get("rolling_links"), SLConfig.deck.transition = e.get("transition"), SLConfig.deck.background_transition = e.get("background_transition"), Reveal.configure({center: !1,rolling_links: SLConfig.deck.rolling_links,transition: SLConfig.deck.transition,backgroundTransition: SLConfig.deck.background_transition}), SL.editor.controllers.Thumbnail.invalidate(), SL.editor.controllers.Contrast.sync(), SL.view.onThemeChanged()
    },promptReload: function() {
        SL.prompt({anchor: this.domElement.find(".save"),title: "The editor needs to reload to apply your changes.",alignment: "t",type: "select",data: [{html: "<h3>Cancel</h3>"}, {html: "<h3>Continue</h3>",className: "positive",callback: this.saveAndReload.bind(this)}]})
    },saveAndReload: function() {
        this.saveData(), SL.view.save(function() {
            window.location.reload()
        }), SL.prompt({anchor: this.domElement.find(".save"),title: 'Saving and reloading...<div class="spinner centered-horizontally"></div>',alignment: "t",optional: !1,options: []}), SL.util.html.generateSpinners()
...
SL("editor.components").SlideOptions = Class.extend({
    init: function(e, t) {
        ...
        return n.attr({"class": e,"data-tooltip": i,"data-tooltip-alignment": "l"}), n.appendTo(this.listElement), n
        ...
        this.overflowWarning || SL.editor.controllers.Capabilities.isTouchEditor() || (this.overflowWarning = $('<div class="overflow-warning"><span class="icon i-info"></span></div>'), this.overflowWarning.attr({"class": "overflow-warning","data-tooltip": "Please keep content inside of the dotted outline. Content placed outside may not be visible on all display sizes.","data-tooltip-maxwidth": 300,"data-tooltip-alignment": "l"})), 0 === this.overflowWarning.parent().length && this.overflowWarning.appendTo(this.domElement)
        ...
        "string" == typeof t && t.length ? (n.css({"background-image": 'url("' + t + '")',"background-repeat": "no-repeat","background-size": "cover"}), o.val(i || "cover"), this.backgroundImageMenu.attr("data-state", "uploaded")) : this.fileUploader ? (n.css("background-image", "none"), this.backgroundImageMenu.attr("data-state", "uploading")) : (n.css("background-image", "none"), this.backgroundImageMenu.attr("data-state", ""))
        ...
        if (!this.notesPrompt) {
            ...
            this.notesPrompt = SL.prompt({anchor: this.notesElement,alignment: "l",title: "Speaker Notes",type: "input",confirmLabel: "Save",data: {value: SLConfig.deck.notes[e],placeholder: "Plain text, max " + t + " characters...",multiline: !0,maxlength: t,confirmBeforeDiscard: !0}}), this.notesPrompt.confirmed.add(function(t) {
        ...
        var e = SL.editor.controllers.Serialize.getSlideAsString(Reveal.getCurrentSlide(), {inner: !0,exclude: ".math-output"}), t = new SL.components.TextEditor({type: "html",value: SL.util.html.indent(e)});
            ...
            if (e) {
                ...
                if (t.length) {
                    var i = $(Reveal.getCurrentSlide()), n = t.map(function(e) {
                        return {value: e,selected: i.hasClass(e),callback: function(e) {
                                i.toggleClass(e), Reveal.sync()
                            }}
                    });
                    this.customClassesPrompt = SL.prompt({anchor: this.customClassesElement,alignment: "l",title: "Slide classes",type: "list",data: n,multiselect: !0,optional: !0}), this.customClassesPrompt.destroyed.add(function() {
        ...
        SL.editor.controllers.Blocks.blur(), SL.prompt({anchor: $(e.currentTarget),title: SL.locale.get("DECK_DELETE_SLIDE_CONFIRM"),alignment: "l",type: "select",data: [{html: "<h3>Cancel</h3>"}, {html: "<h3>Remove</h3>",selected: !0,className: "negative",callback: function() {
        ...
        var t = {anchor: this.backgroundColorElement,alignment: "l",alpha: !1,changeCallback: this.setBackgroundColor.bind(this),resetCallback: this.clearBackgroundColor.bind(this)}, i = Reveal.getCurrentSlide();
        ...
        return this.triggerBackgroundImage(), n && n.type.match(/image.*/) ? "number" == typeof n.size && n.size / 1024 > SL.config.MAX_IMAGE_UPLOAD_SIZE ? void SL.notify("No more than " + Math.round(SL.config.MAX_IMAGE_UPLOAD_SIZE / 1024) + "mb please", "negative") : (this.fileUploader = new SL.helpers.FileUploader({file: n,service: SL.config.AJAX_IMAGE_UPLOAD,timeout: 6e4}), this.syncBackgroundImageMenu(), this.fileUploader.succeeded.add(function(e) {
...
SL("editor.components").Toolbars = Class.extend({
    init: function(e) {
        ...
        var e = this.innerElement.position(), t = {x: e.left,y: e.top,width: this.innerElement.width(),height: this.innerElement.height()};
...
SL("editor.components.toolbars").AddSnippet = SL.editor.components.toolbars.Base.extend({
    init: function() {
        ...
        SL.editor.controllers.Blocks.add({type: "snippet",slide: e,afterInit: function(e) {
                e.setCustomHTML(t), e.resizeToFitContent()
            }})
    },onSnippetClicked: function(e) {
        var t = $(Reveal.getCurrentSlide());
        if (e.templateHasVariables())
            SL.modal.open("insert-snippet", {snippet: e,callback: function(e) {
                    this.insert(t, e)
                }.bind(this)});
        else {
    ...
    init: function() {
        ...
        function o(e) {
            if (a && !l && e.clientX - s > 10) {
                l = !0;
                var i = SL.editor.controllers.Blocks.add({type: t.type,silent: !0,center: !1}), n = $(".reveal .slides").offset(), o = i.measure();
...
SL("editor.components.toolbars.options").Base = Class.extend({
    init: function(e, t) {
        ...
        if (this.domElement = $('<div class="toolbar-option">'), this.config.type && this.domElement.attr("data-option-type", this.config.type), this.config.tooltip && this.domElement.attr({"data-tooltip": this.config.tooltip,"data-tooltip-delay": 1e3,"data-tooltip-maxwidth": 200}), this.config.label && (this.domElement.append('<h4 class="toolbar-option-label">' + this.config.label + "</h4>"), this.config.helpTooltip)) {
            var e;
            e = $(this.config.helpTooltipLink ? '<a class="toolbar-option-help" href="' + this.config.helpTooltipLink + '" target="_blank">' : '<div class="toolbar-option-help">'), e.attr({"data-tooltip": this.config.helpTooltip,"data-tooltip-alignment": "r","data-tooltip-maxwidth": 240}), e.html("?"), e.appendTo(this.domElement.find(".toolbar-option-label"))
        }
    },bind: function() {
...
SL("editor.components.toolbars.options").Color = SL.editor.components.toolbars.options.Value.extend({
    init: function(e, t) {
        ...
        return {anchor: this.triggerElement,alignment: "r",alpha: this.config.alpha,color: this.getValue(),changeCallback: this.setValue.bind(this),resetCallback: this.onResetClicked.bind(this)}
...
SL("editor.components.toolbars.options").Select = SL.editor.components.toolbars.options.Value.extend({
    init: function(e, t) {
        ...
        this.panel = new SL.editor.components.toolbars.util.Panel({type: this.config.panelType,anchor: this.triggerElement,keydown: this.onKeyDown.bind(this),maxHeight: this.config.panelMaxHeight,width: this.config.panelWidth,height: this.config.panelHeight}), this.panel.shown.add(this.onPanelShown.bind(this)), this.config.items.forEach(this.renderItem.bind(this)), this.getListElements().on("vclick", this.onListItemClicked.bind(this))
...
SL("editor.components.toolbars.options").Text = SL.editor.components.toolbars.options.Value.extend({
    init: function(e, t) {
        ...
        this.editor || (this.editor = new SL.components.TextEditor({type: "code",value: this.getValue()}), this.editor.saved.add(function(e) {
...
SL("editor.components.toolbars.options").IframeSRC = SL.editor.components.toolbars.options.Text.extend({
    ...
    init: function(e, t) {
        ...
        e.preventDefault();
        var t = SL.prompt({anchor: this.urlElement,title: "Image URL",type: "input",confirmLabel: "Save",alignment: "r",data: {value: this.block.get("image.src"),placeholder: "http://...",width: 400}});
    ...
    init: function(e, t) {
        ...
        this.expand()
    }}), SL("editor.components.toolbars.options").MathSize = SL.editor.components.toolbars.options.Stepper.extend({init: function(e, t) {
    ...
    }}), SL("editor.components.toolbars.options").Opacity = SL.editor.components.toolbars.options.Range.extend({init: function(e, t) {
        this._super(e, $.extend({type: "opacity",label: "Opacity",property: "style.opacity"}, t))
    }}), SL("editor.components.toolbars.options").Padding = SL.editor.components.toolbars.options.Stepper.extend({init: function(e, t) {
        ...
        this._super.apply(this, arguments), this.syncPaddingHint()
    }}), SL("editor.components.toolbars.options").ShapeFillColor = SL.editor.components.toolbars.options.Color.extend({init: function(e, t) {
        this._super(e, $.extend({type: "shape-fill-color",label: "Color",property: "attribute.data-shape-fill-color",alpha: !0}, t))
    }}), SL("editor.components.toolbars.options").ShapeStretch = SL.editor.components.toolbars.options.Checkbox.extend({init: function(e, t) {
        this._super(e, $.extend({type: "shape-stretch",label: "Stretch to Fill",property: "attribute.data-shape-stretch"}, t))
    }}), SL("editor.components.toolbars.options").ShapeStrokeColor = SL.editor.components.toolbars.options.Color.extend({init: function(e, t) {
        this._super(e, $.extend({type: "shape-stroke-color",label: "Color",property: "attribute.data-shape-stroke-color"}, t))
    }}), SL("editor.components.toolbars.options").ShapeStrokeWidth = SL.editor.components.toolbars.options.Stepper.extend({init: function(e, t) {
        this._super(e, $.extend({type: "shape-stroke-width",label: "Width",property: "attribute.data-shape-stroke-width"}, t))
    }}), SL("editor.components.toolbars.options").ShapeType = SL.editor.components.toolbars.options.Select.extend({init: function(e, t) {
        this._super(e, $.extend({type: "shape-type",panelType: "shape-type",panelWidth: 246,panelMaxHeight: 430,label: "Shape",property: "attribute.data-shape-type",items: e.getPropertySettings("attribute.data-shape-type").options}, t))
    },renderPanel: function() {
    ...
    }}), SL("editor.components.toolbars.options").TextAlign = SL.editor.components.toolbars.options.Radio.extend({init: function(e, t) {
        this._super(e, $.extend({type: "text-align",label: "Text Alignment",property: "style.text-align",items: e.getPropertySettings("style.text-align").options}, t))
    }}), SL("editor.components.toolbars.options").TextColor = SL.editor.components.toolbars.options.Color.extend({init: function(e, t) {
...
SL("editor.controllers").API = {forkDeck: function() {
        ...
        SL.prompt({title: "Are you sure you want to delete this deck?<br>This cannot be undone.",type: "select",data: [{html: "<h3>Cancel</h3>"}, {html: "<h3>Delete</h3>",selected: !0,className: "negative",callback: function() {
                        SL.helpers.PageLoader.show("Deleting..."), $.ajax({type: "DELETE",url: SL.config.AJAX_UPDATE_DECK(SLConfig.deck.id),data: {},context: this}).done(function() {
...
SL("editor.controllers").Blocks = {
    init: function(e) {
        ...
        return t.forEach(function(t) {
            ...
            s.height > 0 && (Math.abs(o.x - r.right) < i ? n.push({relationship: "left",blockA: e,blockB: t}) : Math.abs(o.right - r.x) < i && n.push({relationship: "right",blockA: e,blockB: t})), s.width > 0 && (Math.abs(o.y - r.bottom) < i ? n.push({relationship: "top",blockA: e,blockB: t}) : Math.abs(o.bottom - r.y) < i && n.push({relationship: "bottom",blockA: e,blockB: t}))
        }), n
    },onDocumentMouseDown: function(e) {
        ...
        if (isRevealControls = $(e.target).closest(".reveal .controls").length > 0, isBlock = $(e.target).closest(".sl-block").length > 0, isToolbar = $(e.target).closest(".toolbars").length > 0, !t || isBlock || isRevealControls)
            ...
            if (SL.editor.controllers.Capabilities.isTouchEditor()) {
                ...
                if (i)
                    return this.touchMouseStart = {x: e.clientX,y: e.clientY}, this.touchMouseMoved = !1, $(document).on("vmousemove", this.onTextEditingTouchMove), $(document).on("vmouseup", this.onTextEditingTouchEnd), !0
            }
...
SL("editor.controllers").Capabilities = {
    ...
    init: function() {
    ...
    }}, SL("editor.controllers").Contrast = {init: function() {
    ...
    }}, SL("editor.controllers").Grid = {init: function() {
        ...
        this.canvasElement.css({left: Math.max(l, 10),top: Math.max(c, 10)}), this.canvasElement.attr({width: t,height: i});
    ...
    init: function() {
        ...
        if (this.isEnabled() !== !1) {
            if (this.slideBounds = SL.view.getSlideSize(), this.slideBounds.x = 0, this.slideBounds.y = 0, this.domElement.appendTo(SL.editor.controllers.Markup.getCurrentSlide()), this.allBlocks = SL.editor.controllers.Blocks.getCurrentBlocks(), this.targetBlocks = e, this.gridLines = [], SL.editor.controllers.Grid.isEnabled()) {
                for (var i = SL.editor.controllers.Grid.getCols(), n = SL.editor.controllers.Grid.getRows(), o = this.slideBounds.width / i, r = this.slideBounds.height / n, s = 1; i > s; s++)
                    this.gridLines.push(this.getCenterEdge({x: s * o,y: 0,width: 0,height: this.slideBounds.height}, "grid-col-" + s, "horizontal"));
                for (var a = 1; n > a; a++)
                    this.gridLines.push(this.getCenterEdge({x: 0,y: a * r,width: this.slideBounds.width,height: 0}, "grid-row-" + a, "vertical"))
            }
        ...
        if ("resize" === this.options.action) {
            ...
            this.guides.h = this.guides.h.filter(function(e) {
                ...
                /w|e/.test(this.options.direction) && this.options.direction.indexOf(t.targetEdge.direction) > -1 && (/w/.test(t.targetEdge.direction) ? e.resize({left: t.compareEdge.x,direction: t.targetEdge.direction}) : /e/.test(t.targetEdge.direction) && e.resize({right: t.compareEdge.x,direction: t.targetEdge.direction}))
            }.bind(this)), this.guides.v.forEach(function(t) {
                /n|s/.test(this.options.direction) && this.options.direction.indexOf(t.targetEdge.direction) > -1 && (/n/.test(t.targetEdge.direction) ? e.resize({top: t.compareEdge.y,direction: t.targetEdge.direction}) : /s/.test(t.targetEdge.direction) && e.resize({bottom: t.compareEdge.y,direction: t.targetEdge.direction}))
            }.bind(this))
        } else
        ...
        var r = {top: Math.min(n.bounds.y, t.y),right: Math.max(n.bounds.x + n.bounds.width, t.x + t.width),bottom: Math.max(n.bounds.y + n.bounds.height, t.y + t.height),left: Math.min(n.bounds.x, t.x)};
...
SL("editor.controllers").History = {
    ...
    init: function() {
    ...
    }}, SL("editor.controllers").Markup = {init: function(e) {
        this.editor = e
        ...
        if (e = $(e), t = $(t), t.append(e), e.css("display", "block"), e.find(">section").length)
            ...
            e.children().each(function() {
                ...
                if (e.is(".sl-block"))
                    ...
                    e.css({position: "relative",top: "",right: "",bottom: "",left: ""}), o.html = e.prop("outerHTML"), n.push(o), e.remove()
                }
            }), n.push({html: e.html(),width: SL.config.SLIDE_WIDTH}), e.empty(), n.forEach(function(t) {
                if (t.html.trim().length > 0) {
                    SL.editor.controllers.Blocks.add({type: "text",slide: e,silent: !0,width: t.width,x: t.x,y: t.y,afterInit: function(e) {
    ...
    }}, SL("editor.controllers").Media = {init: function() {
        ...
        $(document.body).append('<div class="drag-and-drop-instructions"></div>'), e.on("dragstart", function() {
            ...
            if (!t) {
                ...
                var n = SL.editor.controllers.Blocks.add({type: "image",slide: $(SL.editor.controllers.Markup.getCurrentSlide())});
...
SL("editor.controllers").Onboarding = {
        ...
        $.ajax({url: SL.config.AJAX_UPDATE_USER,type: "PUT",context: this,data: {user: {editor_tutorial_completed: !0}}}), SL.keyboard.release(this.onKeyDown), this.tutorial.destroy()
    },onKeyDown: function(e) {
    ...
    },step0: {forwards: function() {
            var e = "<h3>Meet the new Slides</h3><p>Click <b>Next</b> to take a quick tour of the new Slides editor.</p>";
            SL.current_user.isEnterprise() || (e += '<p class="de-emphasize">While we\'re in beta you can still use the <a href="' + SL.routes.DECK_NEW(SL.current_user.get("username")) + '?version=1">old editor</a>.</p>'), this.tutorial.message(e, {anchor: $(".sl-tutorial-controls-inner"),alignment: "t",maxWidth: 450})
        }},step1: {forwards: function() {
            var e;
            e = SL.current_user.isPro() || SL.current_user.isEnterprise() ? "<h3>Top Level Options</h3><p>Set the <b>presentation title, privacy, theme and arrange slides</b> from here. You can also manage importing and exporting</p>" : "<h3>Top Level Options</h3><p>Set the <b>presentation title, privacy, theme and arrange slides</b> from here.</p>", this.tutorial.cutout($(".sidebar")), this.tutorial.message(e, {anchor: $(".sidebar"),alignment: "r"})
        },backwards: function() {
            this.tutorial.clearCutout(), this.tutorial.clearMessage()
        }},step2: {forwards: function() {
            this.tutorial.cutout($(".toolbars")), this.tutorial.message("<h3>Add New Content</h3><p>Click on any of these to add a <b>block</b> of content to the current slide.</p>", {anchor: $(".toolbars"),alignment: "r"})
        },backwards: function() {
            this.tutorial.clearCutout(), this.tutorial.clearMessage()
        }},step3: {forwards: function() {
            this.tutorial.cutout($(".sl-block")), this.tutorial.message("<h3>Example Text Block</h3><p>Single-click to focus or double-click to edit text.</p>", {anchor: $(".sl-block"),alignment: "b"})
        },backwards: function() {
            this.tutorial.clearCutout(), this.tutorial.clearMessage()
        }},step4: {forwards: function() {
            this.tutorial.cutout($(".toolbars")), this.tutorial.message("<h3>Block Options</h3><p>Options for the selected block. For text blocks this includes <b>alignment, color, size</b> and more.</p>", {anchor: $(".toolbars"),alignment: "r"}), SL.editor.controllers.Blocks.focus(SL.editor.controllers.Blocks.getCurrentBlocks()[0])
        },backwards: function() {
            this.tutorial.clearCutout(), this.tutorial.clearMessage(), SL.editor.controllers.Blocks.blur()
        }},step5: {forwards: function() {
            SL.editor.controllers.Blocks.blur(), this.tutorial.cutout($(".slide-options"), {padding: 4}), this.tutorial.message("<h3>Slide Options</h3><p>Options for the current slide, such as <b>background color/image and speaker notes</b>.</p>", {anchor: $(".slide-options"),alignment: "l"})
        },backwards: function() {
            this.tutorial.clearCutout(), this.tutorial.clearMessage()
        }},step6: {forwards: function() {
            this.tutorial.cutout($(".add-horizontal-slide"), {padding: 4}), this.tutorial.message("<h3>Adding a Slide</h3><p>Click the plus button to add a new slide.</p>", {anchor: $(".add-horizontal-slide"),alignment: "l"})
        },backwards: function() {
            this.tutorial.clearCutout(), this.tutorial.clearMessage()
        }},step7: {forwards: function() {
            $(".add-horizontal-slide").click(), $(".sl-templates").css("background", "transparent"), this.tutorial.cutout($(".sl-templates-inner")), this.tutorial.message('<h3>Choose a Template</h3><p>When adding a new slide you get to choose from templates. You can save your own templates in the "User" tab.</p>', {anchor: $(".sl-templates-inner"),alignment: "l"})
        },backwards: function() {
            var e = $(".sl-templates");
...
SL("editor.controllers").Selection = {init: function() {
        ...
        i.x = this.startX + Math.min(i.width, 0), i.y = this.startY + Math.min(i.height, 0), i.width = Math.abs(i.width), i.height = Math.abs(i.height), this.domElement.css({left: i.x,top: i.y,width: i.width,height: i.height}), i.x -= this.slideBounds.x, i.y -= this.slideBounds.y, i.x *= SL.util.getRevealCounterScale(), i.y *= SL.util.getRevealCounterScale(), i.width *= SL.util.getRevealCounterScale(), i.height *= SL.util.getRevealCounterScale(), SL.editor.controllers.Blocks.getCurrentBlocks().forEach(function(e) {
            SL.util.trig.intersects(e.measure(), i) ? SL.editor.controllers.Blocks.focus(e, !0, !1) : SL.editor.controllers.Blocks.blur([e])
        }.bind(this))
    },stop: function() {
        this.domElement.remove()
    }}, SL("editor.controllers").Serialize = {getDeckAsString: function(e) {
...
SL("editor.controllers").Session = {
    ...
    }}, SL("editor.controllers").Thumbnail = {init: function() {
        this.invalidated = !1
    },generate: function() {
    ...
    init: function() {
        ...
        this.sidebar = new SL.editor.components.Sidebar, this.toolbars = new SL.editor.components.Toolbars(this), this.colorpicker = new SL.editor.components.Colorpicker, this.slideOptions = new SL.editor.components.SlideOptions(this, {html: this.isDeveloperMode(),fragment: !SL.editor.controllers.Capabilities.isTouchEditorSmall()}), this.slideOptions.syncRemoveSlide(), this.templates = new SL.components.Templates
    },setupReveal: function() {
        var e = {controls: !0,progress: !1,history: !1,center: !1,touch: !1,fragments: !1,help: !1,pause: !1,mouseWheel: !1,rollingLinks: !1,margin: .16,minScale: 1,maxScale: 1,keyboard: {27: null,70: null},keyboardCondition: function() {
            ...
            }.bind(this),rtl: SLConfig.deck.rtl,loop: SLConfig.deck.should_loop,transition: SLConfig.deck.transition,backgroundTransition: SLConfig.deck.background_transition};
        ...
        var e = this.getSlideSize({scaled: !0}), t = window.innerWidth - this.getSidebarWidth(), i = window.innerHeight, n = {left: (t + e.width) / 2,top: (i - e.height) / 2,marginLeft: 0,marginTop: 0};
        ...
        var t = {deck: {title: SL.util.unescapeHTMLEntities((SLConfig.deck.title || "").substr(0, SL.config.DECK_TITLE_MAXLENGTH)),description: SL.util.unescapeHTMLEntities(SLConfig.deck.description),data: SL.util.string.trim(e),css_input: SLConfig.deck.css_input,css_output: SLConfig.deck.css_output,comments_enabled: SLConfig.deck.comments_enabled,forking_enabled: SLConfig.deck.forking_enabled,auto_slide_interval: SLConfig.deck.auto_slide_interval,transition: SLConfig.deck.transition,background_transition: SLConfig.deck.background_transition,theme_font: SLConfig.deck.theme_font,theme_color: SLConfig.deck.theme_color,should_loop: SLConfig.deck.should_loop,rtl: SLConfig.deck.rtl,notes: JSON.stringify(SLConfig.deck.notes),rolling_links: !1,center: !1},version: SL.editor.Editor.VERSION};
        ...
        var o = {type: "POST",url: SL.config.AJAX_CREATE_DECK(SLConfig.current_user.username),context: this,data: this.getSaveData(t)};
        ...
        var t = SL.editor.controllers.Serialize.getDeckAsString(), i = {type: "PUT",url: SL.config.AJAX_UPDATE_DECK(this.savedDeck ? this.savedDeck.id : SLConfig.deck.id),context: this,data: this.getSaveData(t)};
        ...
        var t = {type: "POST",url: SL.config.AJAX_PUBLISH_DECK(SLConfig.deck.id),context: this,data: {visibility: SLConfig.deck.visibility}};
        ...
        e.preventDefault(), e.shiftKey ? SL.editor.controllers.Markup.addHorizontalSlide() : this.templates.show({anchor: this.addHorizontalSlideButton,alignment: SLConfig.deck.rtl ? "l" : "r",callback: function(e) {
                SL.editor.controllers.Markup.addHorizontalSlide(e)
            }})
    },onAddVerticalSlideClicked: function(e) {
        e.preventDefault(), e.shiftKey ? SL.editor.controllers.Markup.addVerticalSlide() : this.templates.show({anchor: this.addVerticalSlideButton,alignment: "b",callback: function(e) {
...
SL("editor.modes").Base = Class.extend({
    init: function(e, t) {
        ...
        this.deactivate()
    }}), SL("editor.modes").Arrange = SL.editor.modes.Base.extend({init: function(e) {
    ...
    init: function(e) {
        ...
        this.currentCSSInput !== this.savedCSSInput ? SL.prompt({anchor: $(e.currentTarget),title: "You will lose all unsaved changes.",alignment: "t",type: "select",data: [{html: "<h3>Cancel</h3>"}, {html: "<h3>Continue</h3>",className: "negative",callback: function() {
                        this.discard(), this.deactivate()
                    }.bind(this)}]}) : (this.discard(), this.deactivate())
    },onSaveClicked: function() {
        this.saveAndClose()
    }}), SL("editor.modes").Fragment = SL.editor.modes.Base.extend({init: function(e) {
        ...
        this.overlays.find(".fragment-overlay-item").each(function(e, t) {
            ...
            s.length && (r = s.css("z-index")), i.css({left: o.x,top: o.y,width: n.outerWidth(!0),height: n.outerHeight(!0),zIndex: r}), i.toggleClass("is-active", n.hasClass("fragment")), i.toggleClass("is-hidden", n.parents(".fragment").length > 0);
            var a = i.find(".index");
    ...
    }}), SL("editor.modes").Preview = SL.editor.modes.Base.extend({init: function(e) {
        this._super(e, "preview"), $(".preview-controls-external").on("click", function() {
            SL.analytics.trackEditor("Open external preview")
        })
    },activate: function() {
        Reveal.isOverview() && Reveal.toggleOverview(!1), this.editor.disableEditing(), this.editor.sidebar.close(), SL.analytics.trackEditor("Preview mode"), this._super(), Reveal.configure({progress: !0,overview: !1,touch: !0,fragments: !0,center: !1,autoSlide: SLConfig.deck.auto_slide_interval || 0});
        var e = Reveal.getIndices();
